                ...
                <div class="mx-auto max-w-6xl px-2 sm:px-4 lg:px-6">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="hidden md:flex items-center space-x-4">
                            ...
                            <div class="relative">
                                <button
                                    class="flex items-center space-x-2 text-gray-700 font-normal py-2 text-nowrap"
                                    @click="isOpen = !isOpen"
                                    @blur="isOpen = false"
                                >
                                    <img
                    ...
                    >
                        ...
                        <div class="relative">
                            ...
                            >
                            <span
                                class="absolute -top-2 right-0 bg-red-600 text-white text-xs font-bold px-2 py-0.5 rounded-full"
                            >
                                0
                            </span>
                        </div>
...
const closeDropDown = () => (
    (mobileMenuOpen.value = false), (mobileMenuButton.value = false)
);
