        ...
        <main class="p-10">
            ...
            <form @submit.prevent="nextStep">
                <div class="mb-4">
                    ...
                    >
                    <p class="md:text-nowrap text-gray-500 mb-1">
...
const calculateMonthlyRate = computed(() => {
    return props.form.hour_per_day * props.form.hourly_rate * 20;
});
...
const minHour = computed(() => {
    return Math.min(props.form.hourly_rate, 1);
});
const minDay = computed(() => {
    return Math.min(props.form.hour_per_day, 1);
});
