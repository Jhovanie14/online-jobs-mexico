...
const calculateMonthlyRate = computed(() => {
    return props.profile.hour_per_day * props.profile.hourly_rate * 20;
});
...
<template>
    <section class="mx-auto">
        <div class="bg-green text-white pb-20 px-2 h-24 md:p-6 text-end">
        ...
        <div class="flex flex-col items-center p-8 bg-white shadow-md">
            <div class="relative mb-20">
                <div
                    class="absolute -top-20 -left-16 w-36 h-36 rounded-full overflow-hidden border-white"
                >
                    <a
                        href="#"
